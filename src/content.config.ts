...
const en = defineCollection({ loader: glob({ pattern: '**/*.{md,mdx}', base: './content/en' }), schema: projectSchema });
const fr = defineCollection({ loader: glob({ pattern: '**/*.{md,mdx}', base: './content/fr' }), schema: projectSchema });

export const collections = { en, fr };